...
Route::post('/Pais','App\Http\Controllers\paisController@store'); //crear un registro
Route::get('/posicions','App\Http\Controllers\posicionsController@index'); //para tener todos los registros y mostrarlos
Route::post('/posicions','App\Http\Controllers\posicionsController@store'); //crear un registro
Route::get('/talla','App\Http\Controllers\tallaController@index'); //para tener todos los registros y mostrarlos
Route::post('/talla','App\Http\Controllers\tallaController@store'); //crear un registro